...
require 'commons-codec-1.6.jar'
require 'httpclient-4.2.3.jar'
require 'httpcore-4.2.2.jar'
require 'jcl-over-slf4j-1.6.4.jar'
require 'jena-arq-2.10.1.jar'
require 'jena-core-2.10.1.jar'
require 'jena-iri-0.9.6.jar'
require 'jena-tdb-0.10.1.jar'
require 'log4j-1.2.16.jar'
require 'slf4j-api-1.6.4.jar'
require 'slf4j-log4j12-1.6.4.jar'
require 'xercesImpl-2.11.0.jar'
